...
export default function DataCollectionQuote() {
    ...
    return (
        <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-2xl mx-auto bg-white rounded-xl border border-gray-200 p-8 shadow-sm mb-16">
                    <h3 className="text-xl font-bold text-[#393F50] text-center mb-6">
                        Get a Quote
                    </h3>
